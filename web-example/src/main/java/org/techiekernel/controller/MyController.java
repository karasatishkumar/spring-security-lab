...
import org.techiekernel.repository.CustomUserDetailsImpl;
import org.techiekernel.spring.user.CustomUserDetailsService;

@Controller
public class MyController {
	
    @Autowired
    private CustomUserDetailsService pudm;
	...
	public ModelAndView add(
        ...
        if ( errorMsg.isEmpty() ) {
            this.pudm.upsertUser(new CustomUserDetailsImpl(name, password));
        }
